...
//     _tCurrentPayable = double.parse(json['current_balance'].toString());
...
//     map['current_balance'] = _tCurrentPayable;
//     map['dates'] = _dates;
//     map['totals'] = _totals;
...
class DataDashboard {
  ...
  DataDashboard.fromJson(dynamic json) {
    // Integer fields
    _tParcel = _toInt(json['t_parcel']);
    _tDelivered = _toInt(json['t_delivered']);
    _tReturn = _toInt(json['t_return']);
    _tRequest = _toInt(json['t_request']);
    _tFraud = _toInt(json['t_fraud']);
    _tShop = _toInt(json['t_shop']);
    _tParcelBank = _toInt(json['t_parcel_bank']);

    // String fields
    _tSale = _toString(json['t_sale'], '0');
    _tDeliveryFee = _toString(json['t_delivery_fee'], '0');

    // Double fields
    _tBalanceProc = _toDouble(json['t_balance_proc']);
    _tBalancePaid = _toDouble(json['t_balance_paid']);
    _tCashCollection = _toDouble(json['t_cash_collection']);
    _tSellingPrice = _toDouble(json['t_selling_price']);
    _tLiquidFragile = _toDouble(json['t_liquid_fragile']);
    _tVatAmount = _toDouble(json['t_vat_amount']);
    _tDeliveryCharge = _toDouble(json['t_delivery_charge']);
    _tCodAmount = _toDouble(json['t_cod_amount']);
    _tPackaging = _toDouble(json['t_packaging']);
    _tDeliveryAmount = _toDouble(json['t_delivery_amount']);
    _tCurrentPayable = _toDouble(json['current_balance']); // API তে current_balance

    // Object
    _merchant = json['merchant'] != null ? Merchant.fromJson(json['merchant']) : null;

    // Lists
    _dates = json['dates'] != null ? List<String>.from(json['dates']) : [];
    _totals = json['totals'] != null ? List<int>.from(json['totals']) : [];
    _pendings = json['pendings'] != null ? List<int>.from(json['pendings']) : [];
    _delivers = json['delivers'] != null ? List<int>.from(json['delivers']) : [];
    _parDelivers = json['par_delivers'] != null ? List<int>.from(json['par_delivers']) : [];
    _returns = json['returns'] != null ? List<int>.from(json['returns']) : [];
  }
...
class Merchant {
  ...
  Merchant.fromJson(dynamic json) {
    ...
    _businessName = json['business_name'];
    _merchantUniqueId = json['merchant_unique_id'];
    _currentBalance = json['current_balance']?.toString() ?? '0';
    _openingBalance = json['opening_balance']?.toString() ?? '0';
    _vat = json['vat']?.toString() ?? '0';
    _codCharges = json['cod_charges'] != null ? CodCharges.fromJson(json['cod_charges']) : null;
    _nidId = json['nid_id'];
    _tradeLicense = json['trade_license'];
    _status = json['status']?.toString();
