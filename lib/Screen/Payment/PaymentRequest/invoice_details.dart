...
class _InvoiceDetailsState extends State<InvoiceDetails> {
  ...
  late Future<InvoiceDetailsModel?> _invoiceFuture;

  @override
  void initState() {
    super.initState();
    _invoiceFuture =
        InvoiceController().getInvoiceDetails(widget.invoiceId);
  }
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: SingleChildScrollView(
          child: FutureBuilder<InvoiceDetailsModel?>(
            ...
            builder: (context, snapshot) {
              ...
              return Column(
                ...
                children: [
                  Column(
                    children: [
                      Text("ID: ${invoiceDetails.invoiceId}",
                          style: TextStyle(fontSize: 17,fontWeight: FontWeight.w600)),
                      SizedBox(height: 10),
                      Text("Date: ${invoiceDetails.invoiceDate}",
                          style: TextStyle(fontSize: 17,fontWeight: FontWeight.w600)),
                      SizedBox(height: 5),
                      Container(
                        padding: EdgeInsets.symmetric(horizontal: 10,vertical: 3),
                        decoration: BoxDecoration(
                            color: invoiceDetails.status == "PAID"
                                ? Colors.green.withOpacity(.3)
                                : Colors.grey.withOpacity(.5),
                            borderRadius: BorderRadius.circular(4)
                        ),
                        child: Text("${invoiceDetails.status}",
                    ...
                    child: Column(
                      children: [
                        Row(
                          ...
                          children: [
                            Text("Total Amount Delivered",
                                style: TextStyle(fontSize: 16,fontWeight: FontWeight.w500)),
                            Text("${invoiceDetails.totalDeliverdAmount?? '0'}",
                                style: TextStyle(fontSize: 16,fontWeight: FontWeight.w500)),
                          ],
                        ),
                        SizedBox(height: 10),
                        ...
                        Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                            Text("Total Return Fee",
                                style: TextStyle(fontSize: 16,fontWeight: FontWeight.w500)),
                            Text("${invoiceDetails.totalReturnFee}",
                                style: TextStyle(fontSize: 16,fontWeight: FontWeight.w500)),
                          ],
                        ),
                        SizedBox(height: 10),
                        Row(
                          ...
                          children: [
                            Text("Delivery Charge",
                                style: TextStyle(fontSize: 16,fontWeight: FontWeight.w500)),
                            Text("${invoiceDetails.deliveryCharge}",
                                style: TextStyle(fontSize: 16,fontWeight: FontWeight.w500)),
                          ],
                        ),
                      ],
                  ...
                  Padding(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.stretch,
                      children: [
                        Text("${invoiceDetails.merchantName}",
                            style: TextStyle(fontSize: 16,fontWeight: FontWeight.w500)),
                        SizedBox(height: 5),
                        Text("${invoiceDetails.merchantPhone}",
                            style: TextStyle(fontSize: 16,fontWeight: FontWeight.w500)),
                        SizedBox(height: 5),
                        Text("${invoiceDetails.merchantAddress}",
                            style: TextStyle(fontSize: 16,fontWeight: FontWeight.w500)),
                      ],
                    ),
                  ),
                  ...
                  Column(
                    children: invoiceDetails.parcels?.map((e) {
                      return Padding(
                              ...
                              child: Column(
                                children: [
                                  ...
                                  Row(
                                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                    children: [
                                      Text("Cash Collection: ${e.cashCollection}",
                                          style: TextStyle(fontWeight: FontWeight.w700)),
                                      Text("Charge: ${e.totalDeliveryAmount??'0'}",
                                          style: TextStyle(fontWeight: FontWeight.w700)),
                                    ],
                                  ),
                                ],
...
//                   log("Invoice Details Response====================>>>>>>>>>>>>: ${snapshot}");
